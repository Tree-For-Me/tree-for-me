...
export class WatsonPersonalityService {

  constructor(private http: HttpClient) { }

  public twitterPersonalityRequest(message: Message): Observable<Plant> {
    let url = '/personality/getTwitterPersonality';
...
//     .set('humidity', plantInfo.humidity? "true":"false")
  ...
  public textPersonalityRequest(message: Message): Observable<Plant> {
      let url = '/personality/getTextPersonality';
